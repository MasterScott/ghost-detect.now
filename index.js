...
var ghostDetect      = require('ghost-detect');
...
app.post('/check', function(req, res, next) {
    ...
    if (!validator.isURL(site)) {
        ...
        ghostDetect(site).then(ghost => {
            if (ghost) {
                status = 'uses <img src="imgs/ghost.svg" href="https://ghost.org">!';
            } else {
                status = 'doesn\'t seem to be using <img src="imgs/ghost.svg" href="https://ghost.org">';
            }
